...
customItems_1.registerCustomItems();
...
var IndentedTree = function (props) {
    var data = props.data, className = props.className, style = props.style, width = props.width, height = props.height, _a = props.nodeType, nodeType = _a === void 0 ? 'card-node' : _a, _b = props.edgeType, edgeType = _b === void 0 ? 'cubic-horizontal' : _b, _c = props.behaviors, behaviors = _c === void 0 ? ['zoom-canvas', 'drag-canvas'] : _c, _d = props.nodeSize, nodeSize = _d === void 0 ? contants_1.defaultNodeSize : _d, _e = props.nodeLabelCfg, nodeLabelCfg = _e === void 0 ? contants_1.defaultLabelCfg : _e, _f = props.nodeAnchorPoints, nodeAnchorPoints = _f === void 0 ? defaultNodeAnchorPoints : _f, _g = props.layout, layout = _g === void 0 ? defaultLayout : _g, minimapCfg = props.minimapCfg, _h = props.nodeStyle, nodeStyle = _h === void 0 ? defaultNodeStyle : _h, _j = props.edgeStyle, edgeStyle = _j === void 0 ? defaultEdgeStyle : _j, _k = props.nodeStateStyles, nodeStateStyles = _k === void 0 ? contants_1.defaultStateStyles : _k, _l = props.edgeStateStyles, edgeStateStyles = _l === void 0 ? contants_1.defaultStateStyles : _l, _m = props.collapseExpand, collapseExpand = _m === void 0 ? true : _m, handleNodeClick = props.handleNodeClick, graphRef = props.graphRef, onReady = props.onReady, loading = props.loading, loadingTemplate = props.loadingTemplate, errorTemplate = props.errorTemplate;
    ...
    react_1.useEffect(function () {
        ...
        utils_1.bindEvents(graph, props);
        return function () {
            if (graphs[graphId]) {
