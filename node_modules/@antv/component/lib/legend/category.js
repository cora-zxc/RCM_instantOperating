...
var Category = /** @class */ (function (_super) {
    ...
    Category.prototype.drawItemText = function (container, textName, cfg, item, itemHeight, xPosition, index) {
        ...
        var style = cfg.style;
        var attrs = tslib_1.__assign(tslib_1.__assign({ x: xPosition, y: itemHeight / 2, text: formatter ? formatter(item[textName], item, index) : item[textName] }, cfg.style), (util_1.isFunction(style) ? style.apply(null, [item[textName], item, index]) : style));
