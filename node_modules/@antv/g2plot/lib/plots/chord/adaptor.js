...
function transformData(params) {
    ...
    // 将数据转换为node link格式
    var chordLayoutInputData = data_1.transformDataToNodeLinkData(data, sourceField, targetField, weightField);
    var _a = chord_1.chordLayout({ weight: true, nodePaddingRatio: nodePaddingRatio, nodeWidthRatio: nodeWidthRatio }, chordLayoutInputData), nodes = _a.nodes, links = _a.links;
    // 1. 生成绘制node使用数据
...
function adaptor(params) {
    ...
    return utils_1.flow(common_1.theme, transformData, coordinate, scale, axis, legend, tooltip, edgeGeometry, nodeGeometry, common_1.interaction, common_1.state, common_1.animation)(params);
}
