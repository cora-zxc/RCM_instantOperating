...
function field(params) {
    ...
    var data = options.data, type = options.type, xField = options.xField, yField = options.yField, colorField = options.colorField, sizeField = options.sizeField, sizeRatio = options.sizeRatio, shape = options.shape, color = options.color;
    chart.data(data);
    var geometry;
    if (type === 'density') {
...
function adaptor(params) {
    ...
    return utils_2.flow(common_1.theme, field, meta, axis, legend, common_1.tooltip, style, label, common_1.annotation(), common_1.interaction, common_1.animation, common_1.state, coordinate)(params);
}
