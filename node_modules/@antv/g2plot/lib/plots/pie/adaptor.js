...
function transformStatisticOptions(options) {
    ...
    if (innerRadius && statistic) {
        var _a = utils_1.deepAssign({}, contants_1.DEFAULT_OPTIONS.statistic, statistic), title = _a.title, content = _a.content;
        if (title !== false) {
            title = utils_1.deepAssign({}, { formatter: function (datum) { return (datum ? datum[colorField] : '总计'); } }, title);
        }
        if (content !== false) {
        ...
        return utils_1.deepAssign({}, { statistic: { title: title, content: content } }, options);
    }
    return options;
}
